...
Hieronder worden een aantal standaard Filament-modules, maar ook zelf gerealiseerde classes benoemd om CMS-functionaliteiten mogelijk te maken.
...
De AllesOnline-developers zijn binnen de TALL-stack (Tailwind CSS, Alpine.js, Laravel, Livewire), waarop Filament is gebouwd, relatief onbekend met Livewire en Alpine.js.

**Aanbeveling:** Bied developers de gelegenheid om ervaring en kennis op te doen met Livewire en Alpine.js.
