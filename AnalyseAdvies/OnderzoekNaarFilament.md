...
2. **Views**: Standaard voorziet een `Resource` weergaven voor een info, create, edit en overview. Deze views kunnen worden aangepast om te voldoen aan specifieke eisen van de eindgebruikers.
